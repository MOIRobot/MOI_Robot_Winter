...
class MoveBaseFloor():
    def __init__(self):
        ...
        goal.target_pose.pose.position.x=-0.101005375385
        goal.target_pose.pose.position.y=4.57547998428 
        goal.target_pose.pose.position.z=0.0
        goal.target_pose.pose.orientation.x=0.0
        goal.target_pose.pose.orientation.y=0.0
        goal.target_pose.pose.orientation.z=0.69395546054
        goal.target_pose.pose.orientation.w=0.72001792949
        self.move(goal)
